...
export async function initCommand(options: InitOptions): Promise<void> {
  ...
  2. Run ${chalk.cyan("meaning validate")} to check your artifact
  3. Run ${chalk.cyan("meaning context")} to generate agent context
...
# Docs: https://github.com/samsonaligba/semantic-authority
